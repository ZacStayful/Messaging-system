      ...
      <div className="mx-auto w-full max-w-[760px] px-4 py-8">
        ...
        <form action={submit} className={`${card} mb-5`}>
          <label className="flex items-start gap-3">
            ...
            <span>
              ...
              <span className="block text-[14px] text-ink-dim">
                While this is off, deliveries are still received and logged below — they just do not create anything.
                Turn it on when you are ready for real customers to be added.
              </span>
            </span>
          </label>
          ...
          <fieldset className="mt-5">
            ...
            <p className="mt-1.5 text-[13px] text-ink-dim">
              The welcome message introduces the team by name, so whoever it introduces should be in the group when it
              is posted.
            </p>
          </fieldset>
        ...
        <div className={`${card} mb-5`}>
          ...
          <p className="mb-3 text-[14px] text-ink-dim">
            On board {props.boardId}: Integrate → Webhooks → &ldquo;When an item is created&rdquo; → send a web request
            to the URL below, with your MONDAY_WEBHOOK_TOKEN on the end.
          </p>
