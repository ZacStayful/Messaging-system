  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-3 p-8 text-center text-muted">
      ...
      <p className="max-w-sm text-[15px]">
        {nav === "later"
          ? "Save any message with the bookmark action and it lands here. Pick one on the left to jump back to it."
          : nav === "files"
            ? "Every file shared in your conversations. Pick one on the left to open it in its chat."
            : "Choose something from the list on the left to start reading and replying."}
      </p>
      {(nav === "dms" || nav === "home") && (
